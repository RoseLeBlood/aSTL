...
LDLIBSOPTIONS=-L../../dist/Release/MinGW-Windows ../../dist/Release/MinGW-Windows/libasstl.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/helloworld.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/helloworld.exe: ../../dist/Release/MinGW-Windows/libasstl.a
