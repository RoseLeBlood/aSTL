...
${OBJECTDIR}/src/PLATFORM.o: src/PLATFORM.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PLATFORM.o src/PLATFORM.cpp

${OBJECTDIR}/src/application.o: src/application.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/application.o src/application.cpp

${OBJECTDIR}/src/asstl.o: src/asstl.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/asstl.o src/asstl.cpp

${OBJECTDIR}/src/filestream.o: src/filestream.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/filestream.o src/filestream.cpp

${OBJECTDIR}/src/intrusive_list.o: src/intrusive_list.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/intrusive_list.o src/intrusive_list.cpp

${OBJECTDIR}/src/intrusive_slist.o: src/intrusive_slist.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/intrusive_slist.o src/intrusive_slist.cpp

${OBJECTDIR}/src/iostream.o: src/iostream.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/iostream.o src/iostream.cpp

${OBJECTDIR}/src/list.o: src/list.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/list.o src/list.cpp

${OBJECTDIR}/src/math/math.o: src/math/math.cpp
	${MKDIR} -p ${OBJECTDIR}/src/math
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/math/math.o src/math/math.cpp

${OBJECTDIR}/src/memory/palloc.o: src/memory/palloc.c
	${MKDIR} -p ${OBJECTDIR}/src/memory
	${RM} "$@.d"
	$(COMPILE.c) -O2 -s -Iinclude -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/palloc.o src/memory/palloc.c

${OBJECTDIR}/src/mutex.o: src/mutex.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mutex.o src/mutex.cpp

${OBJECTDIR}/src/network/address.o: src/network/address.cpp
	${MKDIR} -p ${OBJECTDIR}/src/network
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/network/address.o src/network/address.cpp

${OBJECTDIR}/src/network/physicaladdress.o: src/network/physicaladdress.cpp
	${MKDIR} -p ${OBJECTDIR}/src/network
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/network/physicaladdress.o src/network/physicaladdress.cpp

${OBJECTDIR}/src/new.o: src/new.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/new.o src/new.cpp

${OBJECTDIR}/src/safe_counter.o: src/safe_counter.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/safe_counter.o src/safe_counter.cpp

${OBJECTDIR}/src/slist.o: src/slist.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/slist.o src/slist.cpp

${OBJECTDIR}/src/spinlock.o: src/spinlock.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/spinlock.o src/spinlock.cpp

${OBJECTDIR}/src/split.o: src/split.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -w -s -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/split.o src/split.cpp
